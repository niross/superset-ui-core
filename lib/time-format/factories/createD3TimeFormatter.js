...
function createD3TimeFormatter(config) {
  var description = config.description,
      ...
      formatString = _config$formatString === void 0 ? (0, _utils.isRequired)('formatString') : _config$formatString,
      label = config.label,
      locale = config.locale,
      _config$useLocalTime = config.useLocalTime,
      useLocalTime = _config$useLocalTime === void 0 ? false : _config$useLocalTime;
  var id = useLocalTime ? "" + _TimeFormats.LOCAL_PREFIX + formatString : formatString;
  var formatFunc;
  ...
  if (typeof locale === 'undefined') {
    ...
    var localeObject = (0, _d3TimeFormat.timeFormatLocale)(locale);
