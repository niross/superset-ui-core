    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _ref$client = _ref.client, client = _ref$client === void 0 ? _connection.SupersetClient : _ref$client, _ref$method = _ref.method, method = _ref$method === void 0 ? 'POST' : _ref$method, requestConfig = _ref.requestConfig, _ref$endpoint = _ref.endpoint, endpoint = _ref$endpoint === void 0 ? '/superset/explore_json/' : _ref$endpoint, formData = _ref.formData;
            _context.next = 3;
