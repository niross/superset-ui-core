 ...
 * under the License.
 */
var DTTM_ALIAS = '__timestamp';
exports.DTTM_ALIAS = DTTM_ALIAS;
var EXTRA_FORM_DATA_OVERRIDE_EXTRA_KEYS = ['druid_time_origin', 'relative_start', 'relative_end', 'time_grain_sqla', 'time_range_endpoints'];
exports.EXTRA_FORM_DATA_OVERRIDE_EXTRA_KEYS = EXTRA_FORM_DATA_OVERRIDE_EXTRA_KEYS;
var EXTRA_FORM_DATA_APPEND_KEYS = ['adhoc_filters', 'filters', 'interactive_groupby', 'interactive_highlight', 'interactive_drilldown', 'custom_form_data'];
exports.EXTRA_FORM_DATA_APPEND_KEYS = EXTRA_FORM_DATA_APPEND_KEYS;
var EXTRA_FORM_DATA_OVERRIDE_REGULAR_MAPPINGS = {
...
var EXTRA_FORM_DATA_OVERRIDE_REGULAR_KEYS = Object.keys(EXTRA_FORM_DATA_OVERRIDE_REGULAR_MAPPINGS);
exports.EXTRA_FORM_DATA_OVERRIDE_REGULAR_KEYS = EXTRA_FORM_DATA_OVERRIDE_REGULAR_KEYS;
var EXTRA_FORM_DATA_OVERRIDE_KEYS = [].concat(EXTRA_FORM_DATA_OVERRIDE_REGULAR_KEYS, EXTRA_FORM_DATA_OVERRIDE_EXTRA_KEYS);
