      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            fetchWithRetry = (0, _fetchRetry.default)(fetch, fetchRetryOptions);
            ...
            if (!(method === 'GET' && cache !== 'no-store' && cache !== 'reload' && _constants.CACHE_AVAILABLE && (window.location && window.location.protocol) === 'https:')) {
              _context.next = 24;
              break;
            }

            _context.next = 7;
            return caches.open(_constants.CACHE_KEY);
