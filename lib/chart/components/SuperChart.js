...
var SuperChart = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function SuperChart() {
    ...
    _this.core = void 0;
    _this.createChartProps = _ChartProps.default.createSelector();
    _this.parseDimension = (0, _reselect.createSelector)(function (_ref) {
      ...
      var widthInfo = (0, _dimension.parseLength)(width);
      var heightInfo = (0, _dimension.parseLength)(height);
      ...
      var BoundingBox = widthInfo.isDynamic && heightInfo.isDynamic && widthInfo.multiplier === 1 && heightInfo.multiplier === 1 ? _react.default.Fragment : function (_ref3) {
  ...
  _proto.renderChart = function renderChart(width, height) {
    ...
    if (noResultQueries) {
      ...
      var chartWithoutWrapper = (0, _react2.jsx)(_SuperChartCore.default, {
        ref: this.setRef,
        id: id,
        className: className,
        chartType: chartType,
    ...
    return disableErrorBoundary === true ? chart : (0, _react2.jsx)(_reactErrorBoundary.default, {
      FallbackComponent: function FallbackComponent(props) {
        return (0, _react2.jsx)(_FallbackComponent, _extends({
          width: width,
          height: height
        }, props));
      },
