...
var ChartClient = /*#__PURE__*/function () {
  function ChartClient(config) {
    ...
    var _config = config,
        ...
        client = _config$client === void 0 ? SupersetClient : _config$client;
    this.client = client;
  }
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              metaDataRegistry = getChartMetadataRegistry();
              buildQueryRegistry = getChartBuildQueryRegistry();
