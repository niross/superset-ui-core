...
var getInstance = makeSingleton(TimeFormatterRegistry);
...
export function getTimeFormatter(formatId, granularity) {
  if (granularity) {
    var formatString = formatId || TimeFormatsForGranularity[granularity];
    ...
    return new TimeFormatter({
      ...
      formatFunc: function formatFunc(value) {
        return timeRangeFormatter.format(createTimeRangeFromGranularity(value, granularity, timeRangeFormatter.useLocalTime));
      },
