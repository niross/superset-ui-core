...
export default function buildQueryObject(formData, queryFields) {
  ...
  var _extractQueryFields = extractQueryFields(residualFormData, queryFields),
  ...
  var extras = extractExtras(formData);
  ...
  var extrasAndfilters = processFilters(_extends({}, formData, extras, filterFormData));
